  ...
  useEffect(() => {
    const load = async () => {
      try {
        ...
        setRows([
          { rank: 1, name: "Ghost USD", ticker: "gUSD", iconSrc: "/gusd.svg", lendIntents: gusdLends, borrowIntents: gusdBorrows },
          { rank: 2, name: "Ghost ETH", ticker: "gETH", iconSrc: "/geth.svg", lendIntents: 0, borrowIntents: gethBorrows },
        ]);
      } catch {
        setRows([
          { rank: 1, name: "Ghost USD", ticker: "gUSD", iconSrc: "/gusd.svg", lendIntents: 0, borrowIntents: 0 },
          { rank: 2, name: "Ghost ETH", ticker: "gETH", iconSrc: "/geth.svg", lendIntents: 0, borrowIntents: 0 },
        ]);
      }
    };
    load();

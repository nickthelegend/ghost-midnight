  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3">
        <span className="flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-orange-400 to-orange-600 text-[11px] font-bold text-black">
          {pool.ticker.replace(/^g/i, "").slice(0, 1).toUpperCase() || "G"}
        </span>

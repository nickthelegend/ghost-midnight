...
const StakeCard = () => {
  return (
    <div className="w-full max-w-sm rounded-2xl border border-border bg-card p-6 space-y-5">
      ...
      {/* CTA */}
      <a href="/" className="block w-full rounded-xl py-3.5 text-sm font-semibold text-gray-900 transition-colors cursor-pointer text-center" style={{ backgroundColor: "#ff6a1a" }}>

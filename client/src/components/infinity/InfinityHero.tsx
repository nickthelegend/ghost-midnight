  ...
  return (
    <section className="relative w-full overflow-hidden py-16">
      ...
      <div className="pointer-events-none absolute -right-20 -top-20 h-[500px] w-[500px]">
        <div className="absolute inset-0 rounded-full bg-gradient-to-br from-orange-400 via-yellow-300 to-orange-400 opacity-80 blur-sm" />
        <div className="absolute inset-8 rounded-full bg-gradient-to-tr from-orange-500 via-orange-400 to-orange-400 opacity-70 blur-sm" />
        <div className="absolute inset-16 rounded-full bg-gradient-to-bl from-orange-300 via-orange-300 to-yellow-400 opacity-60 blur-md" />
      </div>

...
const GUSDIcon = () => (
  <div className="w-5 h-5 rounded-full bg-gradient-to-br from-orange-500 to-orange-400" />
);

const GETHIcon = () => (
  <div className="w-5 h-5 rounded-full bg-gradient-to-r from-orange-400 to-orange-500" />
);
